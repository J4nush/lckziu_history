...
<!--  {{items}}-->
  <Carousel :value="items" :numVisible="1" :numScroll="1"
    ...
    <template #item="slotProps">
      ...
      <div :class="slotProps.data.images.length ? 'basis-1/2 border-[#ccc] pl-5 pr-5' : ''" class="text-center flex justify-center items-center pb-5 xl:pb-0 pl-10 pr-10 w-full">
...
.p-carousel .p-carousel-content .p-carousel-prev, .p-carousel .p-carousel-content .p-carousel-next{
  ...
  border-color: rgba(30, 115, 190, .7);
  box-shadow: 0 0 0 0.1rem rgba(30, 115, 190, .7)
}
.p-carousel .p-carousel-content .p-carousel-prev .p-icon, .p-carousel .p-carousel-content .p-carousel-next .p-icon{
  width: 2rem;
  height: 2rem;
}
