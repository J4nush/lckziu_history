...
<!--  {{items}}-->
  <Carousel :value="items" :numVisible="1" :numScroll="1"
    ...
    <template #item="slotProps">
      ...
      <div :class="slotProps.data.images.length ? 'basis-1/2 border-r-2 border-[#ccc] pl-5 pr-5' : ''" class="text-center flex justify-center items-center pl-10 pr-10 w-full">
        <span class="w-full">
        {{ slotProps.data.text }}
        </span>
      </div>
